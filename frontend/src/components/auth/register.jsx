...
const register = () => {
    ...
    const onSubmit = async ( data ) => {
        ...
        try
        {
            ...
            formData.append( "Prénom", data.Lastname );
            formData.append( "Adresse_Email", data.email );
            formData.append( "Mot_de_passe", data.password );
            formData.append( "Genre", data.gender );
            formData.append( "Role", data.role );
            formData.append( "Date_de_Naissance", data.birthday );
            ...
            const res = await fetch( `http://127.0.0.1:8000/api/register`, {
                ...
                mode: 'cors',
                headers: {
                    'Content-Type': 'application/json', // Adjust the content type based on your request
